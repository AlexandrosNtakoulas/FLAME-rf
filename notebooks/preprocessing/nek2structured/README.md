...
- Script: `notebooks/preprocessing/nek2structured/nek2structured.py`
- Config: `notebooks/preprocessing/nek2structured/nek2structured.yaml`

## Quick Start

1. Edit config:
```bash
nano notebooks/preprocessing/nek2structured/nek2structured.yaml
```

2. Run serial:
```bash
python notebooks/preprocessing/nek2structured/nek2structured.py
```

3. Run MPI:
```bash
mpirun -n 8 python notebooks/preprocessing/nek2structured/nek2structured.py
```
