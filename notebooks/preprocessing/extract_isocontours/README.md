...
- Script: `notebooks/preprocessing/extract_isocontours/extract_isocontours.py`
- Config: `notebooks/preprocessing/extract_isocontours/extract_isocontours.yaml`

## Quick Start

1. Edit config:
```bash
nano notebooks/preprocessing/extract_isocontours/extract_isocontours.yaml
```

2. Run serial:
```bash
python notebooks/preprocessing/extract_isocontours/extract_isocontours.py
```

3. Run MPI:
```bash
mpirun -n 8 python notebooks/preprocessing/extract_isocontours/extract_isocontours.py
```
