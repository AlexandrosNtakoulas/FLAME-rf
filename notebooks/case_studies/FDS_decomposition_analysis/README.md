...
- Notebook: `notebooks/case_studies/FDS_decomposition_analysis/FDS_decomposition_analysis.ipynb`
- Config: `notebooks/case_studies/FDS_decomposition_analysis/FDS_decomposition_analysis.yaml`
...
1. Edit config:
```bash
nano notebooks/case_studies/FDS_decomposition_analysis/FDS_decomposition_analysis.yaml
```

2. Open notebook:
```bash
jupyter notebook notebooks/case_studies/FDS_decomposition_analysis/FDS_decomposition_analysis.ipynb
```
