...
- Notebook: `notebooks/case_studies/Model_verification/Model_verification.ipynb`
- Notebook: `notebooks/case_studies/Model_verification/Markstein_lengths_calculation.ipynb`
- Config: `notebooks/case_studies/Model_verification/Model_verification.yaml`
...
1. Edit config:
```bash
nano notebooks/case_studies/Model_verification/Model_verification.yaml
```

2. Open notebook:
```bash
jupyter notebook notebooks/case_studies/Model_verification/Model_verification.ipynb
```

3. For Markstein-length analysis:
```bash
jupyter notebook notebooks/case_studies/Model_verification/Markstein_lengths_calculation.ipynb
```
