...
- Notebook: `applications/case_studies/CNN/CNN.ipynb`
- Config: `applications/case_studies/CNN/CNN.yaml`
...
1. Edit config:
```bash
nano applications/case_studies/CNN/CNN.yaml
```

2. Open notebook:
```bash
jupyter notebook applications/case_studies/CNN/CNN.ipynb
```
