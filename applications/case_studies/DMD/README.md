...
- Notebook: `applications/case_studies/DMD/DMD.ipynb`
- Notebook: `applications/case_studies/DMD/Flame_evolution.ipynb`
- Config: `applications/case_studies/DMD/DMD.yaml`
...
1. Edit config:
```bash
nano applications/case_studies/DMD/DMD.yaml
```

2. Open DMD notebook:
```bash
jupyter notebook applications/case_studies/DMD/DMD.ipynb
```

3. Open flame-evolution notebook:
```bash
jupyter notebook applications/case_studies/DMD/Flame_evolution.ipynb
```
