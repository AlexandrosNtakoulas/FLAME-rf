...
- Notebook: `applications/case_studies/tests/tests.ipynb`
- Config: `applications/case_studies/tests/tests.yaml`
...
1. Edit config:
```bash
nano applications/case_studies/tests/tests.yaml
```

2. Open notebook:
```bash
jupyter notebook applications/case_studies/tests/tests.ipynb
```
