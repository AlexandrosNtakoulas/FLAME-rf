...
- Notebook: `applications/case_studies/Feature_selection/Feature_selection.ipynb`
- Config: `applications/case_studies/Feature_selection/Feature_selection.yaml`
...
1. Edit config:
```bash
nano applications/case_studies/Feature_selection/Feature_selection.yaml
```

2. Open notebook:
```bash
jupyter notebook applications/case_studies/Feature_selection/Feature_selection.ipynb
```
