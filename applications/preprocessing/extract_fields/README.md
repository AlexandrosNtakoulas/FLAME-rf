...
- Script: `applications/preprocessing/extract_fields/extract_fields.py`
- Config: `applications/preprocessing/extract_fields/extract_fields.yaml`

## Quick Start

1. Edit config:
```bash
nano applications/preprocessing/extract_fields/extract_fields.yaml
```

2. Run serial:
```bash
python applications/preprocessing/extract_fields/extract_fields.py
```

3. Run MPI:
```bash
mpirun -n 8 python applications/preprocessing/extract_fields/extract_fields.py
```
