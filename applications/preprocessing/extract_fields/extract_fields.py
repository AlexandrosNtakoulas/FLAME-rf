...
Run examples:
  - Serial:
      PYTHONPATH=. python applications/preprocessing/extract_fields/extract_fields_updated.py
  - MPI:
      PYTHONPATH=. mpirun -n 8 python applications/preprocessing/extract_fields/extract_fields_updated.py

Config file:
  <PROJECT_ROOT>/applications/preprocessing/extract_fields/extract_fields.yaml
"""
...
def main() -> None:
    ...
    config_path = project_root / "applications" / "preprocessing" / "extract_fields" / "extract_fields.yaml"
